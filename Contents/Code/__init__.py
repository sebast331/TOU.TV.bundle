...
MONTHS = [{"french" : "janvier", "english": "January"},{"french" : u"f�vrier", "english": "February"},{"french" : "mars", "english": "March"},
	{"french" : "avril", "english": "April"},{"french" : "mai", "english": "May"},{"french" : "juin", "english": "June"},
	{"french" : "juillet", "english": "July"},{"french" : u"ao�t", "english": "August"},{"french" : "septembre", "english": "September"},
	{"french" : "octobre", "english": "October"},{"french" : "novembre", "english": "November"},{"french" : u"d�cembre", "english": "December"}]
...
def MainMenu():
	...
	oc.add(DirectoryObject(key=Callback(Carrousel), title="En Vedette"))
        oc.add(DirectoryObject(key=Callback(AllShows), title=u"Toutes les �missions"))
        ...
        oc.add(DirectoryObject(key=Callback(BrowseAlphabetically), title=u"Parcourir par ordre alphab�tique"))
...
def Season(show, showId, index):
	...
	for episode in episodes[0]['EpisodeVignetteList']:
		...
		oc.add(EpisodeObject(url=url, title=title, show=show['Titre'], index=ep_index, season=show["NombreEpisodesParSaison"][index]['Key'], summary=summary, thumb=Resource.ContentsOfURLWithFallback(url=thumb), art=Resource.ContentsOfURLWithFallback(url=thumb)))
